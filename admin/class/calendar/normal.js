...
// ---- Common Options ----
var gMonths=["ßíâ","Ôåâ","Ìàðò","Àïð","Ìàé","Èþíü","Èþëü","Àâã","Ñåíò","Îêò","Íîÿá","Äåê"];
...
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You cannot select today!\");return false;' onmouseover='return true;' >Ñåãîäíÿ : "+gToday[2]+" "+gMonths[gToday[1]-1]+", "+gToday[0]+"</A>";	// the content of the bottom section.
