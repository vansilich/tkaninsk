      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="includes/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
...
foreach($blocks as $row){
	echo '<a href="'.$inc_path.'protoblocks/'.$row['folder'].'/admin/">'.$row['name'].'</a><img src="'.$inc_path.'img/line.gif" width="1" height="11" alt="" style="margin:0 11px;" />
	';
