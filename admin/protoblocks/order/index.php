	...
	if($err == 1){
		...
		$msg = '<table style="margin-top:20px;" border="0" cellpadding="4" cellspacing="0">
		  ...
		  <tr style="height:30px;">
			<td class="text_zakas">Имя<span class="star">*</span>:</td>
			<td>'.$face.'</td>
		  </tr>
		  <tr style="height:30px;">
		...
		header('location:/order/?done=true');
	}	

}
$done = get_param('done');
if($done == 'true'){
	echo '<h1>On-line заявка</h1><img src="/img/line_h.gif" width="326" height="37" alt="" /><div class="good_msg">Заказ отправлен. В ближайшее время менеджеры свяжутся с вами.</div>
...
<table style="margin-top:20px;" border="0" cellpadding="4" cellspacing="0">
  ...
  <tr style="height:30px;">
    <td class="text_zakas">Имя<span class="star">*</span>:</td>
    <td><div class="input_fon" ><input class="input" name="face"/></div></td>
  </tr>
  <tr style="height:30px;">
    <td class="text_zakas">E-mail<span class="star">*</span>:</td>
    <td><div class="input_fon" ><input class="input" name="email"/></div></td>
  </tr>
  <tr style="height:30px;">
    <td class="text_zakas">Телефон:</td>
    <td><div class="input_fon" ><input class="input" name="phone"/></div></td>
  </tr> 
