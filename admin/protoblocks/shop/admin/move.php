...
include($inc_path."class/header_adm.php");
	...
	if(isset($_POST['new_cat'])){
		$q->exec("update ".$prefix."goods set catalog=".to_sql($new_cat)." where id=".to_sql($gid));
		//echo "update ".$prefix."goods set cat_id=".to_sql($new_cat)." where id=".to_sql($gid);
		//$catalog->re_calc();
	...
	echo '<a href="index.php?cur_cat='.$cur_cat.'&page='.$page.'">Отмена</a>';
