...
if(empty($_SESSION['user_info']['id'])){
	...
	function check_step6(){
	 ...
	 <div class="h2" style="margin:0 0 10px 0">Создание анкеты:</div>     
	...
	<input type="hidden" name="cmd" value="add" />
	  ...
	  <table cellpadding="0" cellspacing="0" style="padding:10px 13px 0 10px">
		<tr>
		  ...
		  <td>
		  <input class="input" style="width:200px" type="text" name="surname"  placeholder="Фамилия" value="<? echo htmlspecialchars($row['surname']);?>"/><br />
		  <input class="input" style="width:200px"  type="text" name="name"  placeholder="Имя" value="<? echo htmlspecialchars($row['name']);?>"/>
		  <input class="input" style="width:200px; margin-top:5px"  type="text" name="otch"  placeholder="Отчество"  value="<? echo htmlspecialchars($row['name']);?>"/>
		  </td>
		</tr>
		<tr>
...
На фотографии должно быть четко видно лицо кандидата, снимок не должен содержать рекламы (например, логотипа соцсети) и контактов соискателя.
	  ...
	  <table cellpadding="0" cellspacing="0" style="padding:10px 13px 0 10px">
		...
		<tr>
		  ...
		  <td><span class="phonePlus">+</span>
											...
											?>"/><b>(</b>
											<input  style="width:50px" type="text" class="input" style="width:100px"  maxlength="6" size="5" id="phoneCode" name="phoneCode" placeholder="код"     value="<? echo htmlspecialchars($row['phoneCode']);?>" /> <b>)</b>
									 <input  class="input" style="width:247px" type="text" maxlength="7" name="phoneNumber" id="phoneNumber" placeholder="номер" value="<? echo htmlspecialchars($row['phoneNumber']);?>"/></td>
	</td>
		</tr>
		<tr>
	   ...
	   <td><span class="phonePlus">+</span>
											...
											?>"/><b>(</b>
											<input class="input" style="width:50px" type="text" class="input" style="width:100px"  maxlength="6" size="5" id="phoneCode" name="phoneCode" placeholder="код"     value="<? echo htmlspecialchars($row['phoneCode']);?>" /> <b>)</b>
									 <input  class="input" style="width:247px" type="text" maxlength="7" name="phoneNumber" id="phoneNumber" placeholder="номер" value="<? echo htmlspecialchars($row['phoneNumber']);?>"/></td>
	</td>
		</tr>
		<tr>
	  ...
	  <table cellpadding="0" cellspacing="0" style="padding:10px 13px 0 10px">
		...
		<tr>
		  <td class="tr" width="187">Профессиональная сфера<span class="text_red">*</span></td>
		  <td>
		...
		<tr>
		  <td class="tr" width="187">Место работы<span class="text_red">*</span></td>
		...
		<tr>
		  ...
		  <td> 
			...
			<input type="radio" name="komand" value="2"/><div class="div_left" style="margin:3px 10px 0 5px">Не готов к командировкам</div>
	  ...
	  <table cellpadding="0" cellspacing="0" style="padding:10px 13px 0 10px">
		<tr>
		  <td class="tr" width="187">Название компании<span class="text_red">*</span></td>
		...
		<tr>
		  <td class="tr" width="187">Период работы<span class="text_red">*</span></td>
		  <td>
		  с
    ...
    Основное образование — то образование, на котором вы делаете упор в своей профессиональной деятельности.
		...
		<tr>
		  ...
		  <td>с <input class="input" style="width:50px;text-align:center;" type="text" name="ed_y_from" value="<? echo htmlspecialchars($row['ed_y_from']);?>" /> по  <input class="input" style="width:50px;text-align:center;"  type="text" name="ed_y_to" value="<? echo htmlspecialchars($row['ed_y_to']);?>" /> </td>
		</tr>
		<tr>
		  <td class="tr" width="187">Специальность<span class="text_red">*</span></td>
