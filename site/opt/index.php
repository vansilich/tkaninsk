<?$inc_path = "../../admin/"; $root_path="../../" ;include($inc_path."class/header.php");$this_page_id = 4;	$q = new query();
...
<div class="container"><h1><span style="font-size:36px"><strong>ТКАНИ ОПТОМ</strong></span></h1>

<p>Интернет-магазин &laquo;Tkani Nsk&raquo; предлагает купить ткани мелким оптом с перерасчетом розничной цены.</p>

<p>Оптовая цена сохраняется при&nbsp;покупке от&nbsp;одного рулона, независимо от&nbsp;суммы, отреза ткани&nbsp;<strong><em><u>от&nbsp;5&nbsp;метров.</u></em></strong></p>

<p>Как только Вы добавляете в корзину ткань от 5 метров, система автоматически производит перерасчет.</p>

<p>На заказ устанавливается оптовая стоимость.</p>

<p><em>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Пусть наши товары станут вдохновением для реализации ваших проектов.</em></p>
</div>
